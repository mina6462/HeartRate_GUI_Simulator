💓 Heart Rate GUI Simulator
  ...
  The purpose of this project was to gain a greater understanding of numerical method estimations and embedded systems, and to create a physical interface for the user to manipulate. Key OOP concepts were utilized to improve efficiency and interface the hardware with the digital GUI. Using an ultrasonic sensor, mimicked heartbeat motion could be simulated and assessed, which allows for future data analysis. 
